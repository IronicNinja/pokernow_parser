...
names_list = ['rbohr', 'Aceplus', 'Moody', 'mako', 'feelinglucky', 'Wade', ]
tank_small_list = ['Moody', 'Tico', 'mugen', 'feelinglucky', 'Rbohr', 'rbohr', 'Koustav1', 'Seth',
                   'Wade', 'WadeWatts', 'EA', 'sean', 'clc', 'positive ev', 'evan', 'ev']
tank_mid_list = ['den51', 'WyzDM', 'callmidaddy', 'yurrrr', 'NotJ', 'zab',
                   'mol', 'zam', 'Optionality', 'faker', 'Kanye', 'hide', 'steve',
                   'XxBenjiFishyxX', 'grimmbo', 'kev', 'alex', 'alex.', 'dag', 'Kev',
                   'Arrow', 'Noland', 'krish', 'GNRAWR', 'feelinglucky', 'Tico',
                   '〽️ikey', 'Freddy', 'schnoops', 'Nyala', 'Jobey']
